...
public class MovingWindowSumOfSquaresTest
{
	...
	{
		System.out.println("Test of MovingWindowSumOfSquares.execute(float[], int, int, WaveformUtils.WindowType, double, boolean)");
	...
	{
		System.out.println("Test of MovingWindowSumOfSquares.execute(double[], int, int, WaveformUtils.WindowType, double, boolean)");
