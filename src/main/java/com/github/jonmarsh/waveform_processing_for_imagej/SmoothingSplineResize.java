 ...
 * @author Jon N. Marsh
 */
public class SmoothingSplineResize implements ExtendedPlugInFilter, DialogListener
{
	private ImagePlus interpolatedImp;
	private ImageStack interpolatedStack;
	...
	private static int interpolatedWidth = 0;
