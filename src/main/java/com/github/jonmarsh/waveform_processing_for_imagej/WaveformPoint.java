...
/**
 * A simple container for describing the position (x-value) and y-value of a
 * single point in a waveform. This class is primarily useful for maintaining
 * precision in the value of an interpolated position of a point on a uniformly
 * sampled waveform, by separately specifying the closest integer index less
 * than the actual position, and the remaining fractional index (less than
 * {@code 1.0}). The y-value of the point is also stored.
 *
 * @author Jon N. Marsh
 */
public final class WaveformPoint
{
	 ...
	 * {@code baseIndex=0}, {@code fractionalIndex=0.0}, and {@code value=0.0}.
	 */
	 ...
	 * @param fractionalIndex actual index - baseIndex (should {@code >=0.0} and
	 *                        {@code >1.0})
	 ...
	 * {@code baseIndex=Math.floor(x)}, {@code fractionalIndex=x-baseIndex}, and
	 * {@code value=y}.
	 *
	 * @param x ordinal
	 * @param y value
