...
/**
 * This plugin converts text input to a 32-bit floating point grayscale image.
 * Rows are delimited by carriage returns or line-feeds, and columns are
 * delimited with spaces, tabs, or commas.
 *
 * @author Jon N. Marsh
 */
