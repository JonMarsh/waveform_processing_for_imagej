...
/**
 * Retrieves the index of the minimum value of each input waveform and returns
 * the result in a new image. If a waveform has more than one point equal to the
...
public class MinimumIndex implements ExtendedPlugInFilter
{
	...
	public void run(ImageProcessor ip)
	{
		...
		int[] minIndices = execute(pixelsDouble, width);
